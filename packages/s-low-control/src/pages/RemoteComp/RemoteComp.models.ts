import { getRemoteCompList } from "@/services/remoteComp";
...
class RemoteCompModels implements RemoteCompInterface {
  filterParams: any;
  modalShow: boolean;
  pagination: Pagination;
  modalOption: any;
...
export const store = new RemoteCompModels();
